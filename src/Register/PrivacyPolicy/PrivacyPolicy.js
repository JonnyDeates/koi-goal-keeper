...
class PrivacyPolicy extends Component {
    ...
    trackScrolling = () => {
        const wrappedElement = document.getElementById('privacy-policy');
        ...
        return (<section  className={'privacy-policy'}>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to Koi Foundation LLC, Victor Street, CO 80011.</p>
                </li>
                ...
                <li><strong>Website</strong> refers to Koi Goal Keeper, accessible from https://koigoalkeeper.com
                </li>
            ...
            <ul>
                ...
                <li><strong>With other users:</strong> when You share personal information or otherwise interact in
                    ...
                    Media
                    Service, Your contacts on the Third-Party Social Media Service may see You name, profile,
                    pictures
            ...
            <p>California Business and Professions Code section 22581 allow California residents under the age of 18
                who
                are registered users of online sites, services or applications to request and obtain removal of
                content
