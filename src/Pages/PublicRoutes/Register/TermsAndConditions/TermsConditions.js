...
const TermsConditions = () => {
        return (<section className={'terms-conditions'}><h1>Terms and Conditions</h1>

            <p>Last updated: January 19, 2020</p>
            ...
            <ul>
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                    Agreement) refers to Koi Foundation LLC, Victor Street, CO 80011.
                </li>
                <li><strong>Content</strong> refers to content such as text, images, or other information that can be
                ...
                <li><strong>Website</strong> refers to Koi Goal Keeper, accessible from https://KoiGoalKeeper.com</li>
            ...
            <p>The Company reserves the right, but not the obligation, to, in its sole discretion, determine whether or
                ...
                can also limit or revoke the use of the Service if You post such objectionable Content.</p>
            <p>As the Company cannot control all content posted by users and/or third parties on the Service, you agree
            ...
            <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work
                ...
                jonnydeates@gmail.com and include in Your notice a detailed description of the alleged infringement.</p>
            ...
            <p>You can contact our copyright agent via email at jonnydeates@gmail.com.</p>
            <p>Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems
            ...
            <ul>
                <li>By email: jonnydeates@gmail.com</li>
            </ul>
        </section>)
}
